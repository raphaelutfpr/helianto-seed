...
public class S3FileStorage implements FileStorage {
	 ...
	 */
	public S3FileStorage(String baseUrl, String accessKey, String secretAccessKey, String bucketName) {
	...
	public String storeFile(UploadableData uploadableData) throws IOException {
		...
		S3Object object = new S3Object(uploadableData.getName());
		object.setDataInputStream(new ByteArrayInputStream(uploadableData.getBytes()));
		object.setContentLength(uploadableData.getBytes().length);
		object.setContentType(uploadableData.getContentType());		
		...
		return absoluteUrl(uploadableData.getName());
	}
